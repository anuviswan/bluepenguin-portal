...
<template>
  <footer class="footer">
    <div class="footer-content">
      ...
      <div class="section">
        <h3>Customer Care</h3>
        <RouterLink to="/refund-policy" class="footer-link">Refund &amp; Return Policy</RouterLink>
        <RouterLink to="/shipping-policy" class="footer-link">Shipping Policy</RouterLink>
      </div>
      <div class="section">
        <h3>Contact</h3>
        <p>
